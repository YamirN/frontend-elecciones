...
const redirectToLogin = () => {
    router.push('/auth/loginelecciones'); // Rediriges a la ruta deseada
};



const redirectToLoginAdmin = () => {
    router.push('/auth/login'); // Rediriges a la ruta deseada
};
...
<template>
        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            <div
                ...
                <a class="flex items-center" href="#">
                    <img src="/src\assets\img\logoBondy.png" width="50" height="50" loading="lazy"
                        style="object-fit: cover">
                    <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">Augusto
                        Salazar Bondy</span>
                </a>
                ...
                <div
                    ...
                    <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                        ...
                        <button @click="redirectToLoginAdmin"
                            class="bg-blue-400 hover:bg-yellow-600 text-black font-bold py-2 px-4 rounded transition duration-300">
                            Iniciar Sesión
                        </button>
                    </div>
                </div>
            ...
            <div id="hero" class="flex flex-col pt-6 px-6 lg:px-20 overflow-hidden">
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-bold block">Elecciones
                        </span>Estudiantiles 2024</h1>
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700">Tu voto es tu voz. Juntos
                        construimos el futuro de nuestra institución.</p>

                    <button @click="redirectToLogin"
                        class="bg-green-400 hover:bg-yellow-600 text-black font-bold py-3 px-6 rounded transition duration-300">
                        VOTAR
                    </button>
                </div>
                <div class="flex justify-center md:justify-end">
                    <img src="/src/assets/img/bondy.png" alt="Hero Image" class="w-1/6 md:w-auto" />
                </div>
            </div>
            ...
            <!-- <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
                <div class="container mx-auto px-6">
                    <h2 class="text-3xl font-bold text-center mb-12">Candidatos</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div v-for="candidate in candidates" :key="candidate.id"
                            class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4">{{ candidate.proposal }}</p>
                                <button @click="viewCandidateDetails(candidate.id)"
                                    class="w-full bg-red-700 text-white py-2 rounded hover:bg-red-800 transition duration-300">
                                    Ver Detalles
                                </button>
                            </div>
                        </div>
    ...
    <footer class="bg-gray-900 text-white py-8">
        <div class="container mx-auto px-6 text-center">
            <p>&copy; 2024 I.E. 88047 Augusto Salazar. Todos los derechos reservados.</p>
        </div>
    </footer>
</template>
