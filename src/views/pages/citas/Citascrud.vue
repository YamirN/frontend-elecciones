        ...
        <Dialog v-model:visible="showAsignarDialog" modal header="Asignar Trabajador" :style="{ width: '25rem' }">
            <div class="flex flex-col gap-4">
                ...
                <div v-if="trabajadoresDisponibles && trabajadoresDisponibles.length > 0">
                    ...
                    <select id="trabajador" v-model="trabajadorSeleccionado" class="w-full p-2 border rounded">
                        <option disabled value="">Elige uno disponible</option>
                        <option v-for="trabajador in trabajadoresDisponibles" :key="trabajador.id" :value="trabajador.id">
